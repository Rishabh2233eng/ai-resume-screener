...
export default function Landing() {
  ...
  return (
    <div style={{ background: "#060b18", minHeight: "100vh", fontFamily: "'Segoe UI', sans-serif", color: "#e2e8f0", display: "flex", flexDirection: "column" }}>
      ...
      <nav className="landing-nav" style={{ padding: "0 40px", height: "60px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid rgba(255,255,255,0.06)", position: "sticky", top: 0, background: "rgba(6,11,24,0.9)", backdropFilter: "blur(12px)", zIndex: 50 }}>
      ...
      <main className="landing-hero" style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "80px 24px 60px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <h1 className="hero-headline" style={{ fontSize: "clamp(36px, 6vw, 64px)", fontWeight: 700, lineHeight: 1.1, letterSpacing: "-2px", margin: "0 0 24px", maxWidth: "800px", animation: "fadeUp 0.6s ease" }}>
        ...
        <div className="cta-row" style={{ display: "flex", gap: "12px", flexWrap: "wrap", justifyContent: "center", animation: "fadeUp 0.8s ease" }}>
          <button onClick={() => navigate("/register")}
        ...
        <div className="landing-stats" style={{ display: "flex", gap: "48px", marginTop: "64px", flexWrap: "wrap", justifyContent: "center", animation: "fadeUp 1s ease" }}>
          {[
        ...
        <div style={{ display: "flex", gap: "10px", marginTop: "48px", flexWrap: "wrap", justifyContent: "center", animation: "fadeUp 1.1s ease" }}>
          {["Semantic AI matching", "Skill gap analysis", "PDF report export", "Match history", "Premium — ₹99/mo"].map(f => (
