  ...
  return (
    <div style={{ background: "#060b18", minHeight: "100vh", color: "#e2e8f0", fontFamily: "'Segoe UI', sans-serif", padding: "32px 24px" }}>
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "40px" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "4px" }}>
              <div style={{ width: "28px", height: "28px", borderRadius: "8px", background: "linear-gradient(135deg, #2563eb, #06b6d4)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }} onClick={() => navigate("/")}>
        ...
        {loading && <div style={{ textAlign: "center", color: "#475569", padding: "48px 0" }}>Loading dashboard...</div>}

        {stats && (
          <div className="stats-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "12px", marginBottom: "20px" }}>
            {[
          ...
          <div key={a.id} style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "14px", padding: "20px", marginBottom: "12px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px" }}>
              <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
                <span style={{ fontSize: "28px", fontWeight: 700, color: scoreColor(a.fit_score) }}>{parseFloat(a.fit_score).toFixed(1)}%</span>
            ...
            {a.matched_skills && (
              <div style={{ marginBottom: "10px" }}>
                <p style={{ fontSize: "11px", color: "#10b981", marginBottom: "6px", display: "flex", alignItems: "center", gap: "4px" }}>
                  <svg width="11" height="11" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M5 13l4 4L19 7"/></svg>Matched
                </p>
            ...
            {a.missing_skills && (
              <div style={{ marginBottom: "10px" }}>
                <p style={{ fontSize: "11px", color: "#f87171", marginBottom: "6px", display: "flex", alignItems: "center", gap: "4px" }}>
                  <svg width="11" height="11" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M15 9l-6 6m0-6l6 6"/></svg>Missing
                </p>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
